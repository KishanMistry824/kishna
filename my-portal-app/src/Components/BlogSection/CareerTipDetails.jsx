...
// ✅ Include Bootstrap Icons CDN in index.html:
// <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" />
// ✅ Bootstrap CSS CDN also (if not already included):
// <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"/>

const CareerTipDetails = () => {
  // ====== EXPORT TO PDF ======
    ...
    LinkedInData.content.sections.forEach((section) => {
      autoTable(doc, {
        ...
        body: (
          section.tips ||
          section.examples ||
          section.bestPractices || [section.body || ""]
        ).map((item) => [item]),
        theme: "striped",
    ...
    >
      ...
      <div className="career-tip-wrapper">
        ...
        <div className="career-header d-flex align-items-center gap-3 mb-4">
          ...
          <span className="badge-career">{LinkedInData.meta.category}</span>
        </div>
        ...
        <div className="alert alert-primary mt-5 py-3 px-4 rounded">
          ...
          <strong className="text-dark">
            {LinkedInData.content.conclusion.callToAction}
          </strong>
        </div>
...
export default CareerTipDetails;
